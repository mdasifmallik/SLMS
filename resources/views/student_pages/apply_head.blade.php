                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active"><a href="">Apply To Department Head</a></li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <strong>Apply To Department Head</strong>
                </div>
                <div class="card-body card-block">
                    <form action="/store_head" method="post" enctype="multipart/form-data" class="form-horizontal">
                        @csrf
...
<script>
    jQuery(document).ready(function() {
        jQuery(".apply_to_head").addClass("active");
    });
